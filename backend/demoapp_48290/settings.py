"""
Django settings for demoapp_48290 project.
...
ROOT_URLCONF = 'demoapp_48290.urls'
...
WSGI_APPLICATION = 'demoapp_48290.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp_48290 API",
    "DESCRIPTION": "API documentation for demoapp_48290 App",
    "VERSION": "v1",
}
